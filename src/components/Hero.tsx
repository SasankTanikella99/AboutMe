          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 animate-fade-in-up">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Hi, I'm <span className={`bg-gradient-to-r ${yellowTheme.gradient} text-transparent bg-clip-text`}>Sasank Tanikella</span>
              </h1>
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 animate-fade-in-up">
              ...
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-white dark:border-slate-800 shadow-xl">
                <img
                  src="https://media-hosting.imagekit.io/53a7593040e24f00/IMG_0147.jpeg?Expires=1841368800&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=b0uDOcahEUk4H1W2R6IebOWjMvPIiTVeXBEO1rYuFvG-b1sEoww6Ss8wAyuLRMC4AcFoVJB28E4HGQdk7reh~Dbjvlm45W7BMo6anxcC3dgIXhH0TeuK2VoDraQVOPDeUlGnqO0r0wf12hpThb~MJN5TU28adl8t3qydvXJ33NgnjbnJ~S7a7gvTwzvgIakjUaJ84LsQj5eW784vqLC7m366zKxNEhwWNAptJN43RyYtf5O1eINYE5xwHFdC9A26IO1XYMTSW2-sb4YgibMF-Al9hSjSeLFnQp9fnKDKPmOL4pJ74LUfipEXQIDG-VO9QBYByahbXsnNfXXJRF-F2w__"
                  alt="Profile"
